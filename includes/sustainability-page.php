...
<h1>
<?= e($sustainabilityTitle) ?>
</h1>
<p>Measured textile recirculation from completed sales and full returns. No unsupported carbon estimates are used.</p>
</div>
...
<p class="muted">Kilograms, metres, and pieces are intentionally never combined into one total. Retention is net quantity ÷ recirculated quantity.</p>
...
<?= e($row['utilization_percentage']) ?>%</td>
...
<tr>
<th>
<?= $key === 'channels' ? 'Channel' : ($key === 'conditions' ? 'Condition' : 'Material') ?>
</th>
<th>Unit</th>
<th>Recirculated</th>
<th>Returned</th>
