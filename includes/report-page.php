...
<strong>
<?= e($report['summary']['order_count']) ?>
</strong>
</div>
<div class="stat-card">
<span>Quantity sold</span>
<strong>
<?= e(number_format((float) $report['summary']['quantity_sold'], 2)) ?>
</strong>
</div>
<div class="stat-card">
<span>Revenue</span>
<strong>
<?= e(money($report['summary']['revenue'])) ?>
</strong>
</div>
<div class="stat-card">
<span>Gross profit</span>
<strong>
<?= e(money($report['summary']['gross_profit'])) ?>
</strong>
</div>
<div class="stat-card">
<span>Returned revenue</span>
<strong>
<?= e(money($report['summary']['returned_revenue'])) ?>
</strong>
</div>
<div class="stat-card">
<span>Net revenue</span>
<strong>
<?= e(money($report['summary']['net_revenue'])) ?>
</strong>
</div>
<div class="stat-card">
<span>Net profit</span>
<strong>
<?= e(money($report['summary']['net_profit'])) ?>
</strong>
</div>
</div>
<section class="panel">
...
<strong>
<?= e($payment['order_count']) ?> order<?= (int) $payment['order_count'] === 1 ? '' : 's' ?>
</strong>
</div>
<?php endforeach; ?>
...
<td>
<?= e(number_format((float) $row['quantity_sold'], 2)) ?>
</td>
<td>
<?= e(money($row['revenue'])) ?>
</td>
...
<br>
<small class="muted">
<?= e($row['order_type']) ?> · <?= e(date('d M Y', strtotime($row['order_date']))) ?>
</small>
</td>
<td>
<?= e($row['buyer_name']) ?>
...
<td>
<span class="<?= e(statusClass($row['payment_status'])) ?>">
