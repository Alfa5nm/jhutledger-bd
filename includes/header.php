...
<span class="brand-name">JhutLedger<small>Bangladesh</small>
</span>
</a>
...
<a href="<?= e(url('supplier/stock-ledger.php')) ?>">Stock ledger</a>
<a href="<?= e(url('supplier/pricing-assistant.php')) ?>">Pricing assistant</a>
</div>
<div class="nav-group">
<span class="nav-group-label">Sales</span>
<a href="<?= e(url('supplier/quotations.php')) ?>">Quotations</a>
<a href="<?= e(url('supplier/orders.php')) ?>">Orders</a>
<a href="<?= e(url('supplier/reports.php')) ?>">Reports</a>
<a href="<?= e(url('supplier/sustainability.php')) ?>">Recirculation</a>
</div>
...
<a href="<?= e(url('b2b/orders.php')) ?>">Orders</a>
</div>
...
<a href="<?= e(url('admin/exceptions.php')) ?>">Exceptions</a>
<a href="<?= e(url('admin/users.php')) ?>">Users</a>
<a href="<?= e(url('admin/payments.php')) ?>">Payments</a>
</div>
<div class="nav-group">
<span class="nav-group-label">Insight</span>
<a href="<?= e(url('admin/reports.php')) ?>">Reports</a>
<a href="<?= e(url('admin/sustainability.php')) ?>">Recirculation</a>
