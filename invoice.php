...
<title>
<?= e($documentLabel) ?> #<?= e($orderId) ?> | JhutLedger BD</title>
...
<a class="btn btn-outline-primary" href="<?= e(url('order.php?id=' . $orderId)) ?>">Back to order</a>
<button class="btn btn-primary" type="button" onclick="window.print()">Print / Save PDF</button>
</div>
<header class="invoice-head">
<div>
<div class="invoice-brand">JhutLedger <small>Bangladesh</small>
</div>
...
<small>
<?= e(date('d M Y', strtotime($order['order_date']))) ?>
</small>
</div>
</header>
...
<small>
<?= e($order['composition']) ?> · <?= e($order['color']) ?> · <?= e($order['gsm']) ?> GSM · <?= e($order['condition']) ?>
</small>
</td>
<td>
<?= e(number_format((float) $order['quantity'], 2)) ?>
...
<strong>
<?= $order['payment_date'] ? e(date('d M Y, H:i', strtotime($order['payment_date']))) : '—' ?>
</strong>
</div>
</section>
<footer class="invoice-foot">
<p>This document was generated from immutable order-item price and cost snapshots. It is a simulated academic marketplace document and does not represent a real financial transaction.</p>
</footer>
</main>
</body>
</html>
