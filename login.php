...
<main class="container narrow auth-shell">
    <div class="panel">
        ...
        <form method="post">
            <?= csrfField() ?>
            <div class="mb-3"><label class="form-label" for="email">Email</label><input class="form-control" type="email" id="email" name="email" required autocomplete="email" value="<?= e($email) ?>"></div>
