...
<input class="form-control" type="email" id="email" name="email" maxlength="190" required value="<?= e($values['email']) ?>">
</div>
<div>
<label class="form-label" for="phone">Phone</label>
<input class="form-control" id="phone" name="phone" maxlength="30" required value="<?= e($values['phone']) ?>">
</div>
<div>
...
<input class="form-control" id="street" name="street" maxlength="180" required value="<?= e($values['street']) ?>">
</div>
<div>
...
<input class="form-control" id="district" name="district" maxlength="100" required value="<?= e($values['district']) ?>">
</div>
<div>
<label class="form-label" for="postal_code">Postal code</label>
<input class="form-control" id="postal_code" name="postal_code" maxlength="20" required value="<?= e($values['postal_code']) ?>">
</div>
<div>
...
<p class="text-center mt-3 mb-0">Already registered? <a href="<?= e(url('login.php')) ?>">Log in</a>
</p>
</div>
</main>
