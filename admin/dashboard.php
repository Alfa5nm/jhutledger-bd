...
<strong data-count>
<?=e($label === 'Revenue' ? money($value) : $value)?>
</strong>
</div>
<?php endforeach;?>
</div>
...
<h2 class="h4">
<?=e($exceptionTotal)?> items need review</h2>
</div>
<div class="attention-actions">
<?php foreach (array_slice($exceptions, 0, 4, true) as $label => $count):?>
<a href="<?=e(url('admin/exceptions.php'))?>">
<strong>
<?=e($count)?>
</strong>
<span>
...
<a class="btn btn-primary" href="<?=e(url('admin/exceptions.php'))?>">Open exception monitor</a>
</section>
<section class="panel">
<h2 class="h4">Administration tools</h2>
<div class="role-tool-grid">
<a href="<?=e(url('admin/users.php'))?>">Users <span>Search and manage access</span>
</a>
<a href="<?=e(url('admin/payments.php'))?>">Payments <span>Verify manual payments</span>
</a>
<a href="<?=e(url('admin/reports.php'))?>">Reports <span>Review platform performance</span>
</a>
<a href="<?=e(url('admin/database-status.php'))?>">Database <span>Check connection health</span>
</a>
</div>
</section>
</main>
