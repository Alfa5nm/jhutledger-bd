...
<a class="btn btn-outline-primary" href="<?= e(url('admin/reports.php')) ?>">Platform reports</a>
</div>
<section class="filter-bar">
<form method="get" class="filter-grid compact-filters">
<div>
<label class="form-label" for="q">Buyer or order</label>
<input class="form-control" id="q" name="q" value="<?= e($search) ?>" placeholder="Name, email, or order ID">
</div>
<div>
...
<a href="<?= e(url('admin/payments.php')) ?>">Clear</a>
</div>
</form>
</section>
...
<tr>
<td>#<?= e($payment['payment_id']) ?>
<?php if ($payment['payment_date']): ?>
<br>
<small class="muted">
<?= e(date('d M Y, H:i', strtotime($payment['payment_date']))) ?>
</small>
<?php endif; ?>
</td>
<td>
...
<td>
<?= e(money($payment['amount'])) ?>
</td>
<td>
<span class="<?= e(statusClass($payment['payment_status'])) ?>">
...
<button class="btn btn-sm btn-outline-danger" name="status" value="Failed">Mark failed</button>
</form>
<?php else: ?>
