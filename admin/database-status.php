...
<span class="<?=$healthy && !$missing ? 'badge-success' : 'badge-danger'?>">
<?=$healthy && !$missing ? 'Healthy' : 'Needs attention'?>
</span>
</div>
<section class="panel mt-0 <?=$healthy ? 'db-ok' : 'db-down'?>">
<h2 class="h4">Database connection: <?=$healthy ? 'Connected' : 'Unavailable'?>
</h2>
...
<?php if ($missing):?>
<div class="alert alert-danger mt-3 mb-0">Missing tables: <?=e(implode(', ', $missing))?>
</div>
<?php endif;?>
</section>
<?php if ($healthy):?>
...
<td>
<span class="<?=e(statusClass($user['user_status']))?>">
<?=e($user['user_status'])?>
</span>
</td>
<td>
