...
<input class="form-control" id="q" name="q" placeholder="Search name, email, or phone" value="<?=e($search)?>">
</div>
...
<button class="btn btn-sm <?=$user['user_status'] === 'Active' ? 'btn-outline-danger' : 'btn-outline-success'?>" type="submit">
