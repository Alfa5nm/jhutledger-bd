...
<div>
<div class="eyebrow">
<?= e(formatRole(currentUser()['role'])) ?> / Order details</div>
<h1>Order #<?= e($orderId) ?>
</h1>
<p>
<?= e($order['order_type']) ?> order placed <?= e(date('d M Y, H:i', strtotime($order['order_date']))) ?>
</p>
</div>
<div class="action-row">
<a class="btn btn-outline-primary" href="<?= e(url('invoice.php?id=' . $orderId)) ?>">Print invoice</a>
<?php if (currentUser()['role'] === 'supplier'): ?>
<a class="btn btn-primary" href="<?= e(url('supplier/orders.php')) ?>">Back to orders</a>
<?php elseif (currentUser()['role'] === 'admin'): ?>
<a class="btn btn-primary" href="<?= e(url('admin/exceptions.php')) ?>">Operations</a>
<?php else: ?>
...
<a class="btn btn-sm btn-primary" href="<?= e(url('payment.php?order_id=' . $orderId)) ?>">Open payment</a>
</div>
<?php endif; ?>
<?php if ($order['order_status'] === 'Completed' && !$order['has_return']): ?>
<div class="action-row mb-3">
<a class="btn btn-outline-danger" href="<?= e(url('return.php?order_id=' . $orderId)) ?>">Return full order</a>
</div>
<?php endif; ?>
...
<?= $order['order_status'] === $stage ? 'is-current' : '' ?>" <?= $order['order_status'] === $stage ? 'aria-current="step"' : '' ?>>
<span>
<?= e($index + 1) ?>
</span>
<div>
...
<dt>Specification</dt>
<dd>
<?= e($order['composition']) ?> · <?= e($order['color']) ?> · <?= e($order['gsm']) ?> GSM</dd>
</div>
<div>
<dt>Quantity</dt>
<dd>
...
<dd>
<?= currentUser()['role'] === 'supplier' || currentUser()['role'] === 'admin' ? e(money($order['gross_profit'])) : 'Restricted' ?>
</dd>
</div>
<div>
<dt>Order status</dt>
<dd>
<span class="<?= e(statusClass($displayStatus)) ?>">
<?= e($displayStatus) ?>
</span>
</dd>
</div>
...
<small>
<?= e($order['buyer_email']) ?> · <?= e($order['buyer_phone']) ?>
</small>
<small>
...
<small>
<?= e($order['supplier_email']) ?> · <?= e($order['supplier_phone']) ?>
</small>
<small>
...
<div class="party-card">
<span>Quotation #<?= e($order['quotation_id']) ?>
</span>
...
<div>
<span class="movement <?= e($movement['class']) ?>">
<?= e(str_replace('_', ' ', $row['transaction_type'])) ?>
</span>
<strong>
<?= e($movement['symbol']) ?>
<?= e(number_format($movement['quantity'], 2)) ?>
<?= e($order['unit_of_measure']) ?>
</strong>
<small>
<?= e(date('d M Y, H:i', strtotime($row['transaction_date']))) ?> · <?= e($row['remarks'] ?: $movement['effect']) ?>
</small>
</div>
<?php endforeach; ?>
<?php if (!$ledger): ?>
