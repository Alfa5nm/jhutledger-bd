...
if ($sellableQuantity <= 0) throw new RuntimeException('Sold-out test listing has no available quantity.');
...
if (!$duplicateBlocked) throw new RuntimeException('Duplicate active payment was not blocked.');
...
if (!$mismatchedPaymentBlocked) throw new RuntimeException('Mismatched payment amount was not blocked.');
...
if (!$repeatCompletionBlocked) throw new RuntimeException('Repeated order completion was not blocked.');
