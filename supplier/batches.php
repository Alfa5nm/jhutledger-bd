...
<input class="form-control" type="number" step="0.01" min="0.01" name="gsm" required value="<?=e($form['gsm'])?>">
</div>
<div>
...
<input class="form-control" type="number" step="0.01" min="0.01" name="total_quantity" required value="<?=e($form['total_quantity'])?>">
</div>
<div>
<label class="form-label">Average cost per unit (BDT)</label>
<input class="form-control" type="number" step="0.01" min="0" name="average_cost" required value="<?=e($form['average_cost'])?>">
</div>
<div>
...
<img class="textile-thumb" src="<?=e($batchImage['src'])?>" alt="<?=e($batchImage['alt'])?>" width="120" height="80" loading="lazy" decoding="async">
<span>
<strong>
<?=e($batch['material_type'])?>
</strong>
<small class="muted">
<?=e($batch['composition'])?> · <?=e($batch['color'])?>
</small>
...
<td>
<?=e($batch['available_quantity'])?> / <?=e($batch['total_quantity'])?>
<?=e($batch['unit_of_measure'])?>
</td>
<td>
<?=e(money($batch['average_cost']))?>
</td>
<td>
<?=e($batch['listing_count'])?>
</td>
<td>
<span class="<?=e(statusClass($batch['status']))?>">
<?=e($batch['status'])?>
</span>
</td>
<td>
